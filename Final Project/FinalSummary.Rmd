...
library(readxl)
summary <- read_excel("C:\\Users\\jessi\\OneDrive\\Documents\\Google_Data_Analytics_Program\\Case_Study\\Case_Study_Bike_Share\\Year_Summary.xlsx")
View(summary)
```
